...
function Register() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault()
        axios.post('http://localhost:8000/register', { uname, uid, password , department })
            .then(result => {
                alert(result.data);
                navigate('/')
            })
                        ...
                        <Row>
                            ...
                            <Col md='10' lg='6' className='d-flex flex-column align-items-center'>
                                ...
                                <div className="d-flex flex-row align-items-center w-50 mb-4">
                                    ...
                                    <Form.Control required type='text' placeholder='User name' className='w-100' onChange={(e) => setUname(e.target.value)} />
                                </div>
                                ...
                                <div className="d-flex flex-row align-items-center mb-4  w-50">
                                    ...
                                    <Form.Control required type='id' placeholder='User id' onChange={(e) => setUid(e.target.value)} />
                                </div>
